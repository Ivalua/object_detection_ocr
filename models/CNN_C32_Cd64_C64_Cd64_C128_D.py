...
class Network:
    ...
    def build(self, input_shape, num_classes):
        ...
        model.add(Conv2D(64, (3, 3), dilation_rate=(2, 2), activation='relu', padding='valid')) # 28, 28, 1
        model.add(Conv2D(64, kernel_size=(3, 3), activation='relu', padding='valid')) # 28, 28, 1
        model.add(Conv2D(64, (4, 4), dilation_rate=(2, 2), activation='relu', padding='valid')) # 28, 28, 1
        model.add(Dropout(0.25))
        model.add(Conv2D(128, kernel_size=(12,12), strides=(self.stride_scale,self.stride_scale),
