...
class Network:
    ...
    def build(self, input_shape, num_classes):
        ...
        model.add(Conv2D(512, kernel_size=(12,12), strides=(self.stride_scale, self.stride_scale), padding="valid", activation='relu'))
        ...
        output = concatenate([output1, output2, output3], name="output")
