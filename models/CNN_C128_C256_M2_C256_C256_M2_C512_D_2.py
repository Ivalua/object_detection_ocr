...
class Network:
    ...
    def build(self, input_shape, num_classes):
        ...
        model.add(Conv2D(256, (3, 3), activation='relu', padding='valid')) # 28, 28, 1
        model.add(MaxPooling2D(pool_size=(2, 2), strides=(2,2), padding="valid")) # 14, 14, 1
        s1 = model(image_input)

        # stage 2
        s2 = Conv2D(256, kernel_size=(3, 3), activation='relu', padding='valid')(s1)
        s2 = Conv2D(256, (3, 3), activation='relu', padding='valid')(s2)
        s2 = MaxPooling2D(pool_size=(2, 2), strides=(2,2), padding="valid")(s2)

        # output 1
        f1 = Dropout(0.25)(s1)
        f1 = Conv2D(512, kernel_size=(12,12), strides=(self.stride_scale,self.stride_scale),
        ...
        # output 2
        f2 = Dropout(0.25)(s2)
        f2 = Conv2D(512, kernel_size=(11,11), strides=(self.stride_scale,self.stride_scale),
